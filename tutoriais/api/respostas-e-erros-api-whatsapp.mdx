...
<Warning>
  **Endpoints de leitura trazem um nível a mais.** Os endpoints que devolvem registros aninham o resultado num segundo `data`, de forma que o caminho completo é `data.data`. É o comportamento real do servidor e os exemplos desta documentação o refletem. Confira o exemplo de cada endpoint antes de escrever o acesso ao campo.
</Warning>
...
```json Leitura (dois níveis)
{
  "success": true,
  "data": {
    "data": [
      { "id": "...", "phone_number": "5511999999999", "name": "João Silva" }
    ],
    "limit": 20,
    "offset": 0
  },
