...
<ParamField path="GET https://api.wizebot.com.br/v1/whatsapp/custom-fields" />

Lista os campos personalizados configurados na empresa.

```bash
curl 'https://api.wizebot.com.br/v1/whatsapp/custom-fields' \
...
<ParamField path="PATCH https://api.wizebot.com.br/v1/whatsapp/contacts/custom-fields" />
...
```bash
curl -X PATCH 'https://api.wizebot.com.br/v1/whatsapp/contacts/custom-fields' \
  -H 'Authorization: Bearer API-KEY' \
